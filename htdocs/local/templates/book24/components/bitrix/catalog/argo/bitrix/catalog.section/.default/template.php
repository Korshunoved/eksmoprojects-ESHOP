...
<?
	...
	if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS']))
	{
		...
		<div class="bx_catalog_item_controls_blockone"><div style="display: inline-block;position: relative;">
			...
			?>
                <?$qtyMax = ($arItem["CATALOG_CAN_BUY_ZERO"] == "Y") ? 0 : $arItem["CATALOG_QUANTITY"];?>
                <form class="bxr-basket-action bxr-basket-group bxr-currnet-torg" action="">
			<input type="button" class="bxr-quantity-button-minus" value="-" data-item="<?=$arItem["ID"]?>">
			<input type="text" name="quantity" value="1" class="bxr-quantity-text" data-item="<?=$arItem["ID"]?>">
			<input type="button" class="bxr-quantity-button-plus" value="+" data-item="<?=$arItem["ID"]?>" data-max="<?=$qtyMax?>">
...
<!--		<div id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>" class="bx_catalog_item_controls_blocktwo">
			<a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="bxr-basket-add bx_medium" href="javascript:void(0)" rel="nofollow"><?
