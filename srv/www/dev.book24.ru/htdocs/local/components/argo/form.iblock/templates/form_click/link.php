...
<script>
	BX.ready(function(){
            window.Argo = {};
		window.Argo.openForm = function (params) {
			...
			BX.ajax({
				...
				onsuccess: function(data){
					...
					formPopup.show();
					window.Argo.activePopup = formPopup;
				}
			});

		};
		window.Argo.showFormSuccess = function(formId, data){
		...
		window.Argo.formRefresh = function (formId) {
			...
			BX.ajax.submit(BX("iblockForm" + formId),function(data){
				...
				{
					window.Argo.showFormSuccess(formId,data)
					return false;
				}
				BX('ajaxFormContainer_' + formId).innerHTML = data;
			});
