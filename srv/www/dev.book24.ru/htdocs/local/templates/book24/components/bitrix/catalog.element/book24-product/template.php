            ...
            <div class="bookDetal">
                <div class="bookDetalInc">
                    <div class="leftSide">
                        <div class="bookImage">
                            <div class="specialLabel ">
                                <?if ($arResult['PRICES']['BASE']['DISCOUNT_DIFF_PERCENT']){?>
                                    <div class="red"></div>
                                <?}?>
                                <?if ($arResult['PROPERTIES']['AUTOGRAPH']['VALUE_XML_ID']=='Y'){?>
                        ...
                        <?if ($arResult["PROPERTIES"]['FRAGMENT']['VALUE_XML_ID']=='Y'){?>
                            <div class="lightBorderBtn lg" onclick="bookPreview('show',1)">Читать отрывок</div>
                        <?}?>
                        <?if ($arResult["PROPERTIES"]['CHAPTERS']['VALUE']){?>
                    ...
                    <div class="centerSide">
                        ...
                        <div class="bookStatLine">
                            ...
                            <?if ($arResult['PROPERTIES']['COMMENTS']['VALUE'] && count($arResult['PROPERTIES']['COMMENTS']['VALUE'])>0):?>
                                <a href="javascript:void(0)" class="linkWIcon comment"><span class="dottedLink"><?=count($arResult['PROPERTIES']['COMMENTS']['VALUE'])?> отзывов</span></a>
                            <?endif;?>
                               
                            <?if ($arResult['PROPERTIES']['REVIEWS']['VALUE'] && count($arResult['PROPERTIES']['REVIEWS']['VALUE'])>0):?>
                                <a href="javascript:void(0);" class="linkWIcon articles"><span class="dottedLink"><?=count($arResult['PROPERTIES']['REVIEWS']['VALUE'])?> статьи</span></a>
                            <?endif;?>     
                                
                            <?if ($arResult['PROPERTIES']['ORDERS_QUANT']['VALUE'] && $arResult['PROPERTIES']['ORDERS_QUANT']['VALUE']>0):?>
                                <div class="linkWIcon cart"><?=$arResult['PROPERTIES']['ORDERS_QUANT']['VALUE']?> раза купили</div>
                            <?endif;?>
                        </div>
                        <?if ($arResult['PROPERTIES']['PROD_TEXT']['VALUE']['TEXT']) {?>
                                ...
                                <?foreach ($arResult['DISPLAY_PROPERTIES'] as &$arOneProp) {?>
                                    ...
                                    if ($arOneProp['DISPLAY_VALUE'])
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                if ($arResult['PROPERTIES']['AUTHOR_NAME']['VALUE'])
                                                {
                                                    $arValue = explode('>',$arOneProp['DISPLAY_VALUE']);
                                                    $newLinkBegin = $arValue[0].' class="rightTd"';
                                                    $arValue[0] = $newLinkBegin;
                                                    $newLink = $newLinkBegin.'>';
                                                    $newLink .= $arResult['PROPERTIES']['AUTHOR_NAME']['VALUE'];
                                                    $newLink .= '</a>';
                                                }
                                                else
                                                {
                    ...
                    <?if ($arResult['PROPERTIES']['COVER']['VALUE']
                            || $arResult['PROPERTIES']['PAPER']['VALUE']
                            || $arResult['PROPERTIES']['PAGE_Q']['VALUE']
                            || $arResult['PROPERTIES']['FORMAT']['VALUE']
                    ...
                    <?}?>
                        ...
                        <?
                        global $arrTagFilter;
                        $arrTagFilter['ITEM_ID'] = $arResult['ID'];
                        ?>
                        <?$APPLICATION->IncludeComponent(
                        ...
                        <?if ($arResult["PROPERTIES"]['MORE_PHOTO']['VALUE'] && count($arResult["PROPERTIES"]['MORE_PHOTO']['VALUE'])>0) {?>
...
<!--                            <div class="bookTypeSelect">
                            ...
                            <div class="BPrice">
                                <?if ($arResult['PRICES']['BASE']['DISCOUNT_DIFF_PERCENT']){?>
                                    <span class="oldPrice"><?=$arResult['PRICES']['BASE']['PRINT_VALUE']?></span>
        ...
        <div class="contentPart">
            <div class="BTabs">
                <div class="BTabLine">
                    ...
                    <?if (count($arResult['PROPERTIES']['COMMENTS']['VALUE'])>0){?>
                        <div class="tabItem">Отзывы: <?=count($arResult['PROPERTIES']['COMMENTS']['VALUE'])?></div>
                    <?}?>
                    <?if (count($arResult['PROPERTIES']['REVIEWS']['VALUE'])>0){?>
                ...
                <div class="BTabsCont">
                    <div class="BTabsContItem" style="display: block">
                        ...
                        <div class="bookDescrBlock">
                            <?if ($arResult['PROPERTIES']['MICROREVIEWS']['VALUE']) {?>
                                <div class="bookDescrImportant">
                                    <?
                                    $microAr = array();
                                    $arSelectMicro = Array("ID", "NAME",'XML_ID','DETAIL_TEXT','PROPERTY_FROM','PROPERTY_LINK');
                                    $arFilterMicro = Array("IBLOCK_ID"=>6, "XML_ID"=>$arResult['PROPERTIES']['MICROREVIEWS']['VALUE']);
                            ...
                            <?if ($arResult['PROPERTIES']['AWARDS']['VALUE']){?>
                            ...
                            <div class="awardsList">
                                ...
                                <?if ($arResult['PROPERTIES']['AUTHOR']['VALUE']) {?>
                                    ...
                                    <?        
                                    $arFilterAuth = Array("IBLOCK_ID"=>2, "XML_ID"=>$arResult['PROPERTIES']['AUTHOR']['VALUE']);
...
<div class="simpleDialog bookOrder">
    ...
    <div class="popUpForm">
        ...
        <div class="bookOrderCover">
            ...
            <div class="descr">
                <?if ($arResult['PROPERTIES']['COVER']['VALUE']){?>
                    Тип переплета: <?=$arResult['PROPERTIES']['COVER']['VALUE']?><br>
                <?}?>
                <?if ($arResult['PROPERTIES']['PAPER']['VALUE']){?>
                    <?=$arResult['PROPERTIES']['PAPER']['VALUE']?><br>
                <?}?>
                <?if ($arResult['PROPERTIES']['PAGE_Q']['VALUE']){?>
                    Страницы: <?=$arResult['PROPERTIES']['PAGE_Q']['VALUE']?><br>
                <?}?>
                <?if ($arResult['PROPERTIES']['FORMAT']['VALUE']){?>
                    <?
                    $resFromat = CIBlockElement::GetList(Array(), Array("IBLOCK_ID"=>4, "XML_ID"=>$arResult['PROPERTIES']['FORMAT']['VALUE']), false, Array(), array("ID","NAME"));
                    if($obFormat = $resFromat->GetNext())
                    {
                    ?>
                    Формат книги: <?=$obFormat['NAME']?> мм<br>
                    <?}?>
                <?}?>
                <?if ($arResult['CATALOG_WEIGHT']>0){?>
                    Вес книги: <?=$arResult['CATALOG_WEIGHT']/1000?> кг
                <?}?>
            </div>
        </div>
    </div>
    ...
    <div class="BPDCotent">
        <div class="BTabs">
            <div class="BTabLine">
                ...
                <?}?>
                <?if ($arResult['PROPERTIES']['CHAPTERS']['VALUE']['TEXT']){?>
                    <div class="tabItem">Содержание</div>
                <?}?>
                <?if (count($arResult["PROPERTIES"]['QUOTES']['VALUE'])>0){?>
            ...
            <div class="BTabsCont">
                <div class="BTabsContItem" >
                    <div class="bookImagesSlider">
                        ...
                        <div class="bookImagesSliderInc">
                            <div class="largeImage"><img src="<?=$arResult['DETAIL_PICTURE']['SRC']?>"> </div>
                            <h3>Фотографии страниц от издательства и пользователей (<?=count($arResult["PROPERTIES"]['MORE_PHOTO']['VALUE'])?>)</h3>
                            <div class="BImagesLine">
                                <ul>
                                    <?foreach ($arResult["PROPERTIES"]['MORE_PHOTO']['VALUE'] as $key => $value):?>
                                            <?$PIC_URL = \CFile::GetPath($value);?>
                                            
                                            <li class="<?echo ($key==0) ? 'active' : '';?>">
                                                <div class="imageItem ">
                                                    <div class="imageItemInc"><img src="<?=$PIC_URL?>"></div>
                                                </div>
                                            </li>
                                    <?endforeach;?>
                                </ul>
                ...
                <?if ($arResult['PROPERTIES']['CHAPTERS']['VALUE']['TEXT']){?>
                    <div class="BTabsContItem" >
                        <?echo $arResult['PROPERTIES']['CHAPTERS']['~VALUE']['TEXT'];?>
                    </div>
                <?}?>
                <div class="BTabsContItem" style="display: block" >
