...
<a href="javascript:void(0)" id="bxr-catalog-filter-button-open">
	<?=GetMessage('BXR_FILTER_OPEN')?>
</a>

<div class="bx_filter bx_filter_vertical <?=$templateData["TEMPLATE_CLASS"]?>" id="bxr-catalog-filter">
			...
			<div class="bx_filter_button_box active">
				<div class="bx_filter_block">
					<div class="bx_filter_parameters_box_container">
						...
						<input class="bx_filter_search_reset" type="button" id="bxr-catalog-filter-button-close" value="<?=GetMessage("BXR_FILTER_CLOSE")?>" />
...
<script>
	...
	$(document).ready(function(){
		$(document).on('click', '#bxr-catalog-filter-button-close', function(){
			$('#bxr-catalog-filter').hide();
			$('#bxr-catalog-filter-button-open').show();
		});
		$(document).on('click', '#bxr-catalog-filter-button-open', function(){
			$('#bxr-catalog-filter').show();
			$('#bxr-catalog-filter-button-open').hide();
		});
	});
</script>