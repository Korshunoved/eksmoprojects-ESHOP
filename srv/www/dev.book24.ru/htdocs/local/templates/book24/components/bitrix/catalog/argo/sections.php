...
<?  
	...
	else
	{
        ...
        if ($_COOKIE["bookCount"])
            $_SESSION["bookCount"] = $_COOKIE["bookCount"];
        $count = ($_REQUEST['count']) ? $_REQUEST['count'] : $_SESSION["bookCount"];
	...
	?><?$APPLICATION->IncludeComponent(
		...
		array(
			...
			"PAGE_ELEMENT_COUNT" => $count ? $count : $arParams["PAGE_ELEMENT_COUNT"],
